...
document.getElementById('fromOfferRide').addEventListener('change', function () {
  ...
  if (value === "SHU, Karachi") {
    const filteredPlaces = places.filter(place => place !== "SHU, Karachi");
    autocomplete(
    ...
    document.getElementById('toOfferRide').value = "SHU, Karachi";
...
document.getElementById('toOfferRide').addEventListener('change', function () {
  ...
  if (value === "SHU, Karachi") {
    ...
    document.getElementById('fromOfferRide').value = "SHU, Karachi";
